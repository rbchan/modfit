...
$$
R = \frac{\lbrace \prod_{i=1}^n p(y_i|\beta_0^.,\beta_1,\sigma^2)\rbrace p(\beta_0^.)p(\beta_0|\beta_0^.)}{\lbrace \prod_{i=1}^n p(y_i|\beta_0,\beta_1,\sigma^2)\rbrace p(\beta_0)p(\beta_0^.|\beta_0)}
$$
