...
[Linear Model Exercise](exercises/lm/lm.md), so you can always refer
...
distributions. See the [Linear Model Exercise](exercises/lm/lm.md),
...
[Linear Model Exercise](exercises/lm/lm.md) is not fully annotated, so
...
Just like you compared your results to those obtained using **R**
functions, use **JAGS** to do the same (if possible).
