...
![](lm-key_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-2-1.png)
...
These should be closer to 0.65 to increase our effective sample size[1]. Let's rerun the sampler with new tuning values and this time using 2 chains run in parallel:
...
```
    ...
    ## 
    ##          Mean     SD Naive SE Time-series SE
    ## beta0 -0.8745 0.2206 0.001801       0.001864
    ## beta1  0.8207 0.2128 0.001737       0.002193
    ## sigma  2.1871 0.1630 0.001331       0.001890
    ## 
    ## 2. Quantiles for each variable:
    ## 
    ##          2.5%     25%     50%     75%   97.5%
    ## beta0 -1.3055 -1.0220 -0.8750 -0.7255 -0.4364
    ## beta1  0.4026  0.6775  0.8246  0.9643  1.2342
    ## sigma  1.8972  2.0720  2.1788  2.2912  2.5307
